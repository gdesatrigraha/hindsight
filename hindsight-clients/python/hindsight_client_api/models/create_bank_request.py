...
class CreateBankRequest(BaseModel):
    ...
    observation_scope_tag_key_whitelist: Optional[List[StrictStr]] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "disposition", "disposition_skepticism", "disposition_literalism", "disposition_empathy", "mission", "background", "reflect_mission", "retain_mission", "retain_extraction_mode", "retain_custom_instructions", "retain_chunk_size", "retain_structured_chunk_size", "enable_observations", "observations_mission", "observation_scope_tag_key_whitelist", "enable_temporal_retrieval", "enable_graph_retrieval", "enable_reranking"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if observation_scope_tag_key_whitelist (nullable) is None
        # and model_fields_set contains the field
        if self.observation_scope_tag_key_whitelist is None and "observation_scope_tag_key_whitelist" in self.model_fields_set:
            _dict['observation_scope_tag_key_whitelist'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "observation_scope_tag_key_whitelist": obj.get("observation_scope_tag_key_whitelist"),
