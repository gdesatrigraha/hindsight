...
func (o *BankTemplateConfig) GetObservationScopeTagKeyWhitelist() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BankTemplateConfig) GetObservationScopeTagKeyWhitelistOk() ([]string, bool) {
...
func (o *BankTemplateConfig) HasObservationScopeTagKeyWhitelist() bool {
	if o != nil && !IsNil(o.ObservationScopeTagKeyWhitelist) {
		return true
	}
...
func (o *BankTemplateConfig) SetObservationScopeTagKeyWhitelist(v []string) {
